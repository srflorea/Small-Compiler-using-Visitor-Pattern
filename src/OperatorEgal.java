...
/**
 * Clasa ce reprezinta peratorul egal si deriva din clasa Node.
 * @author Razvan
 *
 */
public class OperatorEgal extends Node {
	 ...
	 */
	public OperatorEgal(String nume,int linie,int coloana,String tip)
	{
