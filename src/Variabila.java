/**
 * Clasa ce reprezinta variabile ce vor fi declarate si deriva din clasa Node.
 * @author Razvan
 *
 */
public class Variabila extends Node {
	 ...
	 * @param nume Reprezinta numele variabilei.
	 ...
	 */
	public Variabila(String nume,int linie,int coloana,String tip)
	{
