/**
 * Clasa ce reprezinta peratorul de inmultire si deriva din clasa Node.
 * @author Razvan
 *
 */
public class OperatorInmultire extends Node {
/**
 ...
 */
	public OperatorInmultire(String nume,int linie,int coloana,String tip)
	{
